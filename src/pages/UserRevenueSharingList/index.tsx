...
import UserRevenueSharingListContainer from 'src/containers/UserRevenueSharingList';
// import { fetchResources } from 'src/useCase/userRevenueSharingList';
...
const UserCreatorList: React.FC = () => {
  ...
  return (
    <ContentWrapper title={t('title.user_revenue_sharing_list')}>
      <UserRevenueSharingListContainer />
    </ContentWrapper>
  );
};
